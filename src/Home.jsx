...
<Header/>
<landing className="landing d-flex flex-sm-row flex-column flex-wrap  justify-content-between  ">
...
<a href="./assets/mostafa abas cv.pdf" download='mostafa abas cv.pdf' className=" text-decoration-none fs-5 py-2  px-3 text-capitalize"> download cv</a>
</div>
    </aside>
    <main className=" px-5 position-relative">
<img src={me} alt=""  className="me  w-100 p-3 rounded-circle "/>
...
<a target='_blank'  href =  "https://wa.me/+201280163605? " className="link3"> <img src={whatsApp} alt=""  className="icon3 "/></a>
    ...
    <aside className=" ps-5 d-none  d-md-block">
        <h2 className="fs-4 p-2  ">4 projects</h2>
        <h2 className="fs-4 p-2  ex">1 year experience</h2>
    </aside>
</landing>
</home>
)
